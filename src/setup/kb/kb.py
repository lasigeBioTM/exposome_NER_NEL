...
class KnowledgeBase:
    ...
    def __init__(self, kb, mode, terms_filename=None, edges_filename=None, 
        ...
        if kb == 'chebi' and mode == 'nilinker':
            ...
            if kb in obo_file or input_format == 'obo':
                #name_to_id, id_to_info, synonym_to_id, \
                #    kb_graph, child_to_parent, alt_id_to_id, \
                #    umls_to_hp, edges = self.load_obo()
                self.load_obo()
    ...
    def load_obo(self):
        """Loads KBs from local .obo files (ChEBI, HP, MEDIC, GO) into 
        structured dicts containing the mappings name_to_id, id_to_info, 
        ...
        filepath =  'data/kbs/original_files/'
        ...
        if self.kb == 'hp':
            print('adding')
            edges.append(('HP_0000118', root_id))
            edges.append(('HP_0012823', root_id))
            edges.append(('HP_0000005', root_id))
            edges.append(('HP_0032443', root_id))
            edges.append(('HP:0032223', root_id))
            edges.append(('HP_0040279', root_id))
        """
        #if self.kb == 'hp':
        #    edges.append((root_id, 'HP_0000118'))
        #    edges.append((root_id, 'HP_0012823'))
        #    edges.append((root_id, 'HP_0000005'))
        #    edges.append((root_id, 'HP_0032443'))
        #    edges.append((root_id, 'HP:0032223'))
        #    edges.append((root_id, 'HP_0040279'))
            ...
            for row in reader:
                ...
                if row_count >= 30:
                    ...
                    for parent in node_parents: 
                        ...
                        edges.append((parent.replace(':', '_'), node_id )) #TODO check order of the relation
    ...
    def load_csv(self):
        ...
        with open(filepath) as csv_file:
            ...
            for row in reader:
                ...
                #TODO: fix line below if more KBs are added
    ...
    def load_ncbi_gene(self):
        ...
        with open("data/kbs/original_files/All_Data.gene_info") as ncbi_gene:
    ...
    def load(self):
        ...
        if self.kb == 'chebi' and self.mode == 'nilinker':
            loaded_kb = KnowledgeBase.load_partial_chebi(self)
            
        else:

            if self.kb in self.obo_file or self.input_format == 'obo':
                name_to_id, id_to_name, synonym_to_id, kb_graph, \
                    child_to_parent, alt_id_to_id, umls_to_hp, \
                    edges = self.load_obo()
                self.name_to_id = name_to_id
                self.id_to_name = id_to_name
                self.synonym_to_id = synonym_to_id
                ...
                loaded_kb = KnowledgeBase.load_csv(self)
            
            elif self.kb == 'ncbi_gene':
                loaded_kb = KnowledgeBase.load_ncbi_gene(self)
            
            else:
                 
                if self.input_format == 'txt':
                    loaded_kb = KnowledgeBase.load_txt(self)
