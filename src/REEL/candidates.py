...
def write_candidates_file(kb, doc_entities_candidates, candidates_dir, 
                          entity_type, kb_edges, link_mode, 
                          extracted_relations, doc_id):
    """
    ...
    #doc_entities_candidates = entities_candidates[doc_id]
