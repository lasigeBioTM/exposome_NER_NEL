...
class WordConcept:
    ...
    def __init__(self, partition):
        ...
        self.filepath = "data/NILINKER/word_concept/wc_" + partition + ".json"
...
def get_wc_embeds(partition):
    ...
    embeds_dir = "./data/NILINKER/embeddings/{}/".format(partition)
...
def get_kb_data(partition):
    ...
    source_filename = 'data/kbs/dicts/{}/id_to_name.json'.format(partition)

    if partition == 'chebi':
        source_filename = 'data/kbs/dicts/chebi/id_to_name_nilinker.json'
